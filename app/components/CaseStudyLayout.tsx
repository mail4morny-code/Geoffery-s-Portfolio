  ...
  return (
    <div className="min-h-screen bg-[color:var(--bg)] text-[color:var(--text)]">
      ...
      <motion.main
        initial="hidden"
        animate="show"
        className="mx-auto w-full max-w-5xl px-6 pb-24 pt-16 sm:pt-24"
      >
        ...
        <motion.section variants={section} className="space-y-6">
          ...
          <h1 className="break-words text-[40px] font-semibold leading-[1.05] text-[color:var(--text)] sm:text-[64px] lg:text-[80px]">
            {study.title}
          </h1>
          <p className="text-base text-[color:var(--muted)] sm:text-xl">
            {study.overview}
          </p>
        </motion.section>
